                ...
                <div class="row justify-content-md-center pt-1 pt-md-3">
                    ...
                    <div class="blue_box mb-4">
                        <div class="blue_box_bg">
                            <input v-model="radioALL" class="Apply_input" name="radioALL" id="radioALL" runat="server" type="radio" value="Y" />
                            ...
                            <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <Field
                                              ...
                                              rules="required"
                                              :class="{ 'is-invalid': errors['第三人行銷'],'form-check-input':errors['第三人行銷'] }"
                                              class="Apply_input"
                                              name="第三人行銷"
                                              id="three_promote_Y"
                                              runat="server"
                                            ...
                                            />
                                            <label class="form-check-label red_text me-3 fw-bold" for="three_promote_Y">同意</label>
                                            <Field
                                              v-model="Form.ThreePromote"
                                              rules="required"
                                              :class="{ 'is-invalid': errors['第三人行銷'], 'form-check-input':errors['第三人行銷']}"
                                              ...
                                              :validateOnInput="true"
                                            />
                                            <label class="form-check-label red_text fw-bold" for="three_promote_N">不同意</label>
                                            <span class="red_text">提供個人資料予貴行有特約合作之第三人</span>
                                            <ErrorMessage
                                              name="第三人行銷"
                                ...
                                <div class="dashed_line mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <Field
                                          ...
                                          rules="required"
                                          :class="{ 'is-invalid': errors['聯名集團共同行銷'], 'form-check-input':errors['聯名集團共同行銷']}"
                                          class="Apply_input"
                                          name="聯名集團共同行銷"
                                          id="Common_Promote_Y"
                                          runat="server"
                                          ...
                                          :validateOnInput="true"
                                        />
                                        <label class="form-check-label red_text me-3 fw-bold" for="Common_Promote_Y">同意</label>
                                        <Field
                                          v-model="Form.CommonPromote"
                                          rules="required"
                                          :class="{ 'is-invalid': errors['聯名集團共同行銷'], 'form-check-input':errors['聯名集團共同行銷']}"
                                          ...
                                          :validateOnInput="true"
                                        />
                                        <label class="form-check-label red_text fw-bold" for="Common_Promote_N">不同意</label>
                                        <p class="d-block text-danger ms-2">{{errors['聯名集團共同行銷']}}</p>
                                    </div>
                                ...
                                <div class="dashed_line mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <Field
                                          ...
                                          rules="required"
                                          :class="{ 'is-invalid': errors['聯邦銀行LINE官方綁定個人化服務'], 'form-check-input':errors['聯邦銀行LINE官方綁定個人化服務']}"
                                          class="Apply_input"
                                          ...
                                          :validateOnInput="true"
                                        />
                                        <label class="form-check-label red_text me-3 fw-bold" for="Line_Service_Y">同意</label>
                                        <Field
                                          v-model="Form.LineService"
                                          rules="required"
                                          :class="{ 'is-invalid': errors['聯邦銀行LINE官方綁定個人化服務'], 'form-check-input':errors['聯邦銀行LINE官方綁定個人化服務']}"
                                          ...
                                          :validateOnInput="true"
                                        />
                                        <label class="form-check-label red_text fw-bold" for="Line_Service_N">不同意</label>
                                        <ErrorMessage
                                          name="聯邦銀行LINE官方綁定個人化服務"
                                          class="d-block text-danger ms-2"
                                        />
                                ...
                                <div class="dashed_line mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input v-model="Form.EasyCardDisable" class="Apply_input" name="" id="EasyCardDisable" runat="server" type="checkbox" />
                                        <label class="form-check-label fw-bold me-3" for="EasyCardDisable">不同意開啟</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="terms-group" v-if="$route.fullPath === '/OnLineApply_Fillin_OT_1'">
                        <div class="terms">
                            <input
                              ...
                              id="checkbox"
                              name="allTerms"
                              :class="{ 'is-invalid': errors['有關條款'], 'form-check-input':errors['有關條款']}"
                    ...
                    <div class="text-center button_group">
                        <button @click.prevent="submit" class="btn btn-primary btn-lg mx-1">預覽申請書</button>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="level-one">
                                <div class="cjk-ideographic">
                                    ...
                                    <div class="level-two">
                                        ...
                                        <p>(三)
                                            本行現採各筆帳款之入帳日為起息日，各筆循環信用利息之計算，係將每筆「得計入循環信用本金之帳款」，自各筆帳款入帳日起（每期應付分期本金遲延利息之計算，係自繳款截止日起計算），就該帳款之金額以帳款入帳日時適用之約定利率計算至該筆帳款結清之日止（元以下四捨五入），惟繳款後剩餘未付款項不足新臺幣1,000元，則各筆帳款入帳日後發生之循環信用利息及違約金，不予計收。
                                        </p>
                                        <p class="red">(四)
...
export default {
  ...
  watch: {
    ...
    Form: {
      handler (n, o) {
        if (n.ThreePromote === 'N' || n.CommonPromote === 'N' || n.LineService === 'N') {
          this.radioALL = false
        }
      },
      deep: true
  ...
  methods: {
    ...
    checkRadioAll () {
      ...
      if (!this.allTerms) {
        this.$refs.form.setFieldError('有關條款', '您尚未勾選詳細閱讀並同意有關條款')
      }
    },
    async submit () {
