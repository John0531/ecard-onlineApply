										...
										:validation-schema="customSchema" @submit="onSubmit" @invalid-submit="onInvalidSubmit"
																			...
																			<ul class="formList-even">
																					...
																					<li class="col-12 col-md-12">
																							...
																							<div class="form-check">
																									<Field  class="form-check-input mt-2 position-absolute" type="radio" name="帳單形式"  value="paper" :class="{ 'is-invalid': errors['帳單形式']}" v-model="onLineApply_Fillin_Data.bill" :validateOnChange="true"></Field>
																									<div class="form_Apply_txt">
																																	紙本帳單
																									</div>
																							</div>
																					...
																					<li class="col-12 col-md-12">
																							...
																							<div class="d-flex flex-wrap justify-content-start align-items-center" v-if="onLineApply_Fillin_Data.sendCardAddress === 'other'">
																									<div class="d-inline-flex">
																											...
																											<div>
																													<Field v-model="cardFour" name="末四碼" type="text" maxlength="4" class="form-control end_four" :class="{ 'is-invalid': errors['末四碼'] }" :validateOnChange="true" @keyup="cardFour = $custom.validate.OnlyNumPress(cardFour)"/>
																									...
																									<li style="padding-left: 0px;" class="mt-3Address.L mt-3" >
																											...
																											<div class="d-flex apply_address align-items-center mt-3">
																													<!-- errors不要綁錯 -->
																													<Field v-model="onLineApply_Fillin_Data.address.ln" name="巷" maxlength="5" type="text" class="form-control me-1"
																													:class="{ 'is-invalid': errors['巷'] }" :validateOnChange="true" @keyup="onLineApply_Fillin_Data.address.ln = $custom.validate.OnlyNumPress(onLineApply_Fillin_Data.address.ln)"></Field>巷
																													<Field v-model="onLineApply_Fillin_Data.address.aly" name="弄" maxlength="5" type="text" class="form-control mx-1"
																													:class="{ 'is-invalid': errors['弄'] }" :validateOnChange="true" @keyup="onLineApply_Fillin_Data.address.aly = $custom.validate.OnlyNumPress(onLineApply_Fillin_Data.address.aly)"></Field>弄
																													<Field v-model="onLineApply_Fillin_Data.address.no_1" name="號1" maxlength="5" type="text" class="form-control mx-1"
																													:class="{ 'is-invalid': errors['號1'] }" :validateOnChange="true" @keyup="onLineApply_Fillin_Data.address.no_1 = $custom.validate.OnlyNumPress(onLineApply_Fillin_Data.address.no_1)"></Field>-
																													<Field v-model="onLineApply_Fillin_Data.address.no_2"  name="號2" maxlength="5" type="text" class="form-control mx-1"
																													:class="{ 'is-invalid': errors['號2'] }" :validateOnChange="true" @keyup="onLineApply_Fillin_Data.address.no_2 = $custom.validate.OnlyNumPress(onLineApply_Fillin_Data.address.no_2)"></Field>號
																													<Field v-model="onLineApply_Fillin_Data.address.floor" name="樓" maxlength="5" type="text" class="form-control mx-1"
																													:class="{ 'is-invalid': errors['樓'] }" :validateOnChange="true" @keyup="onLineApply_Fillin_Data.address.floor = $custom.validate.OnlyNumPress(onLineApply_Fillin_Data.address.floor)"></Field>樓
																					...
																					<li class="col-12 col-md-12">
																							...
																							<div class="d-flex flex-wrap flex-column flex-md-row">
																									<div class="form-check me-4">
																											<Field class="form-check-input mt-2 position-absolute" type="radio" name="申請數位卡" value="digitalTrue" v-model="onLineApply_Fillin_Data.digitalCard"/>
																											<div class="form_Apply_txt text-nowrap">
																															是 (有效期至核卡後次月底)
																											</div>
																									</div>
																									<div class="form-check me-4">
																											<Field class="form-check-input mt-2 position-absolute" type="radio" name="申請數位卡" value="digitalFalse" v-model="onLineApply_Fillin_Data.digitalCard"/>
																											<div class="form_Apply_txt">
																															否
																											</div>
																									</div>
																			...
																			<div class="terms-group">
																					<div class="terms">
																							...
																							<label for="agree">同意，本人對「<a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" @click.prevent="checkAgreement"><u>用卡須知及申請說明</u></a>」「<a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" @click.prevent="checkAgreement"><u>重要告知事項</u></a>」「 <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" @click.prevent="checkAgreement"><u>聯邦信用卡約定條款</u></a>」「 <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" @click.prevent="checkAgreement"><u>電子化帳單服務約定條款</u></a>」 <div v-if="this.contract">「<a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" @click.prevent="checkAgreement"><u>{{contract.item}}</u></a>」</div>內容。(請務必勾選)
																							</label>
																					</div>
																			</div>
									...
									<div class="modal-body">
											...
											<div id="terms_box_2" class="terms_box" @scroll="checkTermsScroll($event,2)">
													...
													<div class="txt">
															...
															<div>五、本人申請書上填載為學生身分，貴行會將發卡情事通知本人父母或法定代理人，請其注意本人使用信用卡情形。貴行如發現未據實告知學生身分者，將依前段約定辦理，且只持有超過3家及每家信用額度已超過新台幣2萬元之情事，貴行將立即通知停止本人卡片的使用。
															</div>
															...
															<div class="red">※本人確認業經合理期間詳細審閱並完全了解貴行依個人資料保護法第八條所進行之告知內容及本申請書所列信用卡相關利率、費用項目及收取標準(詳如信用卡利率/費用一覽表)，並就上述聲明事項、正反面所載有關申請聯邦銀行信用卡用卡須知及重要約定事項之內容，同意提供個人資料予貴行及遵守信用卡約定條款之規定，茲簽名如下以示負責。【附卡申請人同意貴行將約定條款或其他業務上應為之通知（如帳單等)，向正卡申請人送達即對附卡申請人發生相同之效力。】
															</div>
											...
											<div id="terms_box_3" class="terms_box" @scroll="checkTermsScroll($event,3)">
													...
													<div class="txt">
															...
															<div>
																	第二十三條（喪失期限利益及契約之終止）
																	<div class="l-two-em">
																			<span class="red">持卡人如有前條第一項各款事由之一或本契約終止者，發卡機構無須事先通知或催告，得隨時縮短持卡人延後付款期限或視為全部到期。<br>持卡人如有前條第二項各款事由之一者，經發卡機構事先通知或催告後，發卡機構得隨時縮短持卡人延後付款期限或視為全部到期。持卡人死亡者，亦同。</span>
											...
											<!------------------5-------------------------------------------->
											<div id="terms_box_5" class="terms_box" @scroll="checkTermsScroll($event,5)" v-if="this.contract">
											...
											<div id="button_terms_5" class="button_terms" v-if="this.contract">
...
export default {
  ...
  watch: {
    ...
    'onLineApply_Fillin_Data.sendCardAddress': {
      hadler (newVal, oldVal) {
        ...
        this.onLineApply_Fillin_Data.address.ln = ''
        this.onLineApply_Fillin_Data.address.aly = ''
        this.onLineApply_Fillin_Data.address.no_1 = ''
        this.onLineApply_Fillin_Data.address.no_2 = ''
        this.onLineApply_Fillin_Data.address.floor = ''
        this.onLineApply_Fillin_Data.address.other = ''
        this.onLineApply_Fillin_Data.billAddress = ''
        this.onLineApply_Fillin_Data.companyAddress = ''
        if (newVal === 'sameBill') {
          this.onLineApply_Fillin_Data.billAddress = '台北市內湖區康寧路Ｏ段'
        } else if (newVal === 'sameCompany') {
          this.onLineApply_Fillin_Data.companyAddress = '台北市內湖區康寧路Ｏ段ＯＯＯ巷ＯＯ號Ｏ樓'
        }
      },
      deep: true
    }
  ...
  async mounted () {
    ...
    this.onLineApply_Fillin_Data.address.dist = ''
    this.onLineApply_Fillin_Data.address.rd = ''
    const x = await service.getSetTestValue()
    console.log('x', x)
  }
}
</script>
