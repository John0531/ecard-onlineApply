            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div ref="termBox1" id="terms_box_1" class="terms_box oneTerms">
                        ...
                        <div class="txt">
                            ...
                            <div class="level-one">
                                ...
                                <div class="l-two-em">
                                    <div class="cjk-ideographic"><span class="red">一、「電子銀行服務」：指貴行藉由各種電子通訊機制，包括電話通訊或網路（不包含ATM自動提款機服務）建構之電子銀行服務通路，即電話銀行、個人網路銀行及行動銀行。</span></div>
                    ...
                    <div id="button_terms" class="button_terms">
                        <input type="checkbox" id="button_termsOpt_1" @click="checkAgreement()" disabled=""
                        v-model="agreement" />
