                ...
                <li class="inOpt">
                  ...
                  <div>
                    <Field
                      ...
                      v-model="form.msg"
                      @keyup="form.msg = $custom.validate.OnlyNumPress(form.msg)"
                  ...
                  <span class="countdown" v-show="!show">({{ count }}秒後重新發送)</span>
                </li>
              </ul>
            </div>
...
export default {
  ...
  // async mounted () {
  //   const reuslt = await service.getOtp()
  //   console.log(reuslt)
  //   // await this.getMsgCode()
  // }
}
</script>
