              ...
              <ul class="formList-even">
                ...
                <li class="col-12 col-md-12">
                  ...
                  <div class="d-flex apply_address align-items-center">
                    <Field
                      ...
                      @change="Form.homeAddr.Lane = $custom.validate.NumOnlyWithoutFirstZero(Form.homeAddr.Lane)"
                      maxlength="5"
                    ...
                    <Field
                      ...
                      @change="Form.homeAddr.Aly = $custom.validate.NumOnlyWithoutFirstZero(Form.homeAddr.Aly)"
                      maxlength="5"
                    ...
                    <Field
                      ...
                      @change="Form.homeAddr.Of = $custom.validate.NumOnlyWithoutFirstZero(Form.homeAddr.Of)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['戶籍地址'] }"
                    ...
                    <Field
                      ...
                      @change="Form.homeAddr.Flr = $custom.validate.NumOnlyWithoutFirstZero(Form.homeAddr.Flr)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['戶籍地址'] }"
                ...
                <li class="col-12 col-md-12">
                  ...
                  <div class="d-flex apply_address align-items-center">
                    <Field
                      ...
                      @change="Form.liveAddr.Lane = $custom.validate.NumOnlyWithoutFirstZero(Form.liveAddr.Lane)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['居住地址'] }"
                    /><span class="input_number_text">巷</span>
                    <Field
                      ...
                      @change="Form.liveAddr.Aly = $custom.validate.NumOnlyWithoutFirstZero(Form.liveAddr.Aly)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['居住地址'] }"
                    /><span class="input_number_text">弄</span>
                    ...
                    <Field
                      ...
                      @change="Form.liveAddr.Of = $custom.validate.NumOnlyWithoutFirstZero(Form.liveAddr.Of)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['居住地址'] }"
                    /><span class="input_number_text">號</span>
                    <Field
                      ...
                      @change="Form.liveAddr.Flr = $custom.validate.NumOnlyWithoutFirstZero(Form.liveAddr.Flr)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['居住地址'] }"
                    /><span class="input_number_text">樓</span>
                ...
                <li class="col-12 col-md-6">
                  ...
                  <div class="d-flex office_tel align-items-center">
                    <Field
                      ...
                      maxlength="4"
                      @change="Form.home.homeAreaCode?$custom.validate.chkKeyValueLength(Form.home.homeAreaCode,$refs.form,'戶籍電話區碼',2,4):'';Form.home.homeAreaCode = $custom.validate.OnlyNumPress(Form.home.homeAreaCode)"
                ...
                <template v-if="Form.isStudent==='true'">
                  ...
                  <li class="col-12 col-md-6">
                    ...
                    <Field
                      ...
                      @change="Form.parentTel = $custom.validate.OnlyNumPress(Form.parentTel)"
                    />
                    <ErrorMessage
                      name="家長聯絡電話"
                      class="field-error"
                  ...
                  <li class="col-12 col-md-12">
                    ...
                    <div class="d-flex apply_address align-items-center">
                      <Field
                        ...
                        @change="Form.parentAddr.Lane = $custom.validate.NumOnlyWithoutFirstZero(Form.parentAddr.Lane)"
                        maxlength="5"
                        class="form-control input_number"
                        :class="{ 'is-invalid': errors['家長通訊地址'] }"
                      /><span class="input_number_text">巷</span>
                      <Field
                        ...
                        @change="Form.parentAddr.Aly = $custom.validate.NumOnlyWithoutFirstZero(Form.parentAddr.Aly)"
                        maxlength="5"
                        class="form-control input_number"
                        :class="{ 'is-invalid': errors['家長通訊地址'] }"
                      /><span class="input_number_text">弄</span>
                      ...
                      <Field
                        ...
                        @change="Form.parentAddr.Of = $custom.validate.NumOnlyWithoutFirstZero(Form.parentAddr.Of)"
                        maxlength="5"
                        class="form-control input_number"
                        :class="{ 'is-invalid': errors['家長通訊地址'] }"
                      /><span class="input_number_text">號</span>
                      <Field
                        ...
                        @change="Form.parentAddr.Flr = $custom.validate.NumOnlyWithoutFirstZero(Form.parentAddr.Flr)"
                        maxlength="5"
                        class="form-control input_number"
                        :class="{ 'is-invalid': errors['家長通訊地址'] }"
                      /><span class="input_number_text">樓</span>
                ...
                <li class="col-12 col-md-6">
                  ...
                  <Field
                    ...
                    @change="Form.uniformNum = $custom.validate.OnlyNumPress(Form.uniformNum)"
                    type="text"
                    class="form-control"
                  />
                  <ErrorMessage
                ...
                <li class="col-12 col-md-6">
                  ...
                  <div class="d-flex office_tel align-items-center">
                    <Field
                      ...
                      @change="Form.comp.compAreaCode = $custom.validate.OnlyNumPress(Form.comp.compAreaCode)"
                      type="text"
                      class="form-control AreaCode me-1"
                    />-
                    <Field
                      ...
                      @change="Form.comp.compTel = $custom.validate.OnlyNumPress(Form.comp.compTel)"
                      type="text"
                    ...
                    <Field
                      ...
                      @change="Form.comp.compExt = $custom.validate.OnlyNumPress(Form.comp.compExt)"
                      type="text"
                ...
                <li class="col-12 col-md-12">
                  ...
                  <div class="d-flex apply_address align-items-center">
                    <Field
                      ...
                      @change="Form.compAddr.Lane = $custom.validate.NumOnlyWithoutFirstZero(Form.compAddr.Lane)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['公司地址'] }"
                    /><span class="input_number_text">巷</span>
                    <Field
                      ...
                      @change="Form.compAddr.Aly = $custom.validate.NumOnlyWithoutFirstZero(Form.compAddr.Aly)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['公司地址'] }"
                    /><span class="input_number_text">弄</span>
                    ...
                    <Field
                      ...
                      @change="Form.compAddr.Of = $custom.validate.NumOnlyWithoutFirstZero(Form.compAddr.Of)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['公司地址'] }"
                    /><span class="input_number_text">號</span>
                    <Field
                      ...
                      @change="Form.compAddr.Flr = $custom.validate.NumOnlyWithoutFirstZero(Form.compAddr.Flr)"
                      maxlength="5"
                      class="form-control input_number"
                      :class="{ 'is-invalid': errors['公司地址'] }"
                    /><span class="input_number_text">樓</span>
                ...
                <li class="col-12 col-md-6">
                  ...
                  <Field
                    ...
                    @change="Form.jobTenure = $custom.validate.NumOnlyWithoutFirstZero(Form.jobTenure)"
                    name="年資"
                    type="text"
                    class="form-control"
                    maxlength="2"
                ...
                <li class="col-12 col-md-6">
                  ...
                  <Field
                    ...
                    @change="Form.salary = $custom.validate.NumOnlyWithoutFirstZero(Form.salary)"
                  />
                  <ErrorMessage
                    name="月收入"
                    class="field-error"
