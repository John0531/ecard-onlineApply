          ...
          <div class="row justify-content-md-center pt-1 pt-md-3">
              ...
              <div class="stepGroup">
                <ul class="step">
                  ...
                  <li>
                      <div class="counter_step">3</div><span>檢附身份證及財力證明</span></li>
                </ul>
              </div>
              <!------------------------//步驟---------------------------------->

              <div class="mb-4 text-left"><strong>申請人資料</strong> <small class="red_text">*請務必填寫</small></div>
                      ...
                      <ul class="formList-even">
                          ...
                          <li class="col-12 col-md-6">
                              ...
                              <div class="d-flex ID_date align-items-center">
                                  <select name="" runat="server" class="form-select form-control IDCounty mr-1 mr-md-2">
                                      <option>台北市</option>
                                      <option>新北市</option>
                                  </select>
                          ...
                          <li class="col-12 col-md-6">
                              ...
                              <div class="d-block d-md-flex align-items-center">
                                  <input required="" name="login[id]" type="text" placeholder="" class="form-control me-0 me-md-2">
                          ...
                          <li class="col-12 col-md-12">
                              ...
                              <div class="d-flex flex-wrap flex-column flex-md-row">
                                  <div class="form-check me-4">
                                      <input class="form-check-input mt-2 position-absolute" type="radio" name="exampleRadios" id="" value="option1">
                                      <div class="form_Apply_txt">
                                          同戶籍地址
                                      </div>
                                  </div>
                          ...
                          <li class="col-12 col-md-6">
                              ...
                              <div class="d-flex office_tel align-items-center">
                                  <input required="" name="login[id]" type="text" placeholder=" " class="form-control AreaCode me-1">-
                                  <input required="" name="login[id]" type="text" placeholder=" " class="form-control mx-1"><span class="text-nowrap">分機</span>
                                  <input required="" name="login[id]" type="text" placeholder=" " class="form-control Ext ms-1">
                              </div>
                          </li>
                          <li class="col-12 col-md-12">
                          ...
                          <li class="col-12 col-md-6">
                              ...
                              <div class="d-flex flex-wrap flex-md-nowrap align-items-center">
                                  <select name="" runat="server" id="" class="form-select form-control me-1">
                                      <option></option>
                                      <option></option>
                                      <option></option>
                                  </select>
                                  <div class="d-flex align-items-center">
                                      ...
                                      <input required="" name="login[id]" type="text" placeholder=" " class="form-control other_input ms-1 my-2 my-md-0">
                                  </div>
                              </div>
                          </li>
                          <li class="col-12 col-md-6">
                              <label for=""><span class="red_text">* </span>主要所得及資金來源</label>
                              <div class="d-flex flex-wrap flex-md-nowrap align-items-center">
                                  <select name="" runat="server" id="" class="form-select form-control me-1">
                                      <option></option>
                                      <option></option>
              ...
              <div class="text-center button_group">
                  <button onclick="location.href='OnLineApply_Fillin_OT_1.htm'" class="btn btn-primary btn-lg mx-1" type="submit" value="">下一步</button>
              </div>
          </div>
      </div>
  </section>
