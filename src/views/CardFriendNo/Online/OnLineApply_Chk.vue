    ...
    <div class="row justify-content-md-center pt-1 pt-md-3">
        ...
        <div class="Apply_Chk mb-5">
              <div class="col-12 Apply_banksGroup">
                ...
                <span class="blue_text">指定銀行：玉山銀行、永豐銀行、遠東商銀、日盛商銀、台新商銀、星展銀行、新光商銀、元大銀行、陽信銀行、華泰銀行、三信商銀、華南商銀、樂天信用卡、台中商銀、滙豐銀行、土地銀行、合作金庫、臺灣中小企銀、彰化銀行、高雄銀行、臺灣銀行、台北富邦銀行、中國信託、兆豐商銀、凱基銀行、國泰世華、渣打商銀、上海商銀、安泰商銀等。</span>
              </div>
        </div>
        <Form
            v-slot="{errors}"
