              ...
              <div class="formGroup">
                ...
                <div class="Apply_Chk mb-5">
                    <div class="col-12 Apply_banksGroup">
                        ...
                        <span class="blue_text">指定銀行：臺灣銀行、臺灣土地銀行、合作金庫商業銀行、第一商業銀行、華南商業銀行、彰化商業銀行、上海商業儲蓄銀行、台北富邦商業銀行、國泰世華商業銀行、高雄銀行、兆豐國際商業銀行、全國農業金庫、花旗(台灣)商業銀行、王道商業銀行、臺灣中小企業銀行、渣打國際商業銀行、台中商業銀行、京城商業銀行、瑞興商業銀行、華泰商業銀行、臺灣新光商業銀行、陽信商業銀行、基隆第一信用合作社、板信商業銀行、淡水第一信用合作社、新竹第三信用合作社、台中市第二信用合作社、三信商業銀行、彰化第六信用合作社、花蓮第二信用合作社、高雄第三信用合作社、農金資訊股份有限公司、遠東國際商業銀行、元大商業銀行、永豐商業銀行、玉山商業銀行、凱基商業銀行、星展(台灣)商業銀行、台新國際商業銀行、日盛國際商業銀行、安泰商業銀行、中國信託商業銀行、財團法人農漁會南區資訊中心。</span>
                    </div>
                </div>
                <div class="formGroup">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div id="button_terms" class="button_terms">
                      <input type="checkbox" id="button_termsOpt_1" v-model="agreement" value="agree1"                          disabled="" />
                  ...
                  <div id="button_terms_2" class="button_terms">
                      <input type="checkbox" id="button_termsOpt_2" v-model="agreement" value="agree2"                          disabled="" />
                  ...
                  <div id="button_terms_3" class="button_terms">
                      <input type="checkbox" id="button_termsOpt_3" v-model="agreement" value="agree3"                          disabled="" />
                  ...
                  <div id="button_terms_4" class="button_terms">
                      <input type="checkbox" id="button_termsOpt_4" v-model="agreement"
                      value="agree4"                        disabled="" />
