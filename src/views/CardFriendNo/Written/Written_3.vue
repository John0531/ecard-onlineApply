    ...
    <section class="mainArea">
        <div class="container-xl">
            <div class="row justify-content-md-center pt-1 pt-md-3">
                <div class="col-lg-2 mb-4 text-left"><img src="images/form/card_b4s.jpg" class="img-fluid" alt="" /></div>
                <div class="col-lg-10 mb-4 Apply_text">
                    <p><img src="images/form/Apply_icon.gif" class="img-fluid me-1" alt="" />微風悠遊聯名卡MasterCard悠遊鈦金卡</p>
                    <p><img src="images/form/Apply_icon.gif" class="img-fluid me-1" alt="" />推廣資料<span class="red_text">專案代號：ETU</span></p>
                    <p><img src="images/form/Apply_icon.gif" class="img-fluid me-1" alt="" />首刷禮：(代碼1) 刷卡金500元</p>
                </div>
                    ...
                    <div class="blue_box_bg">
                        <div class="col-md-12 col-lg-10 m-auto">
                            <ul class="group_confirm ps-0 mb-0">
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>身分證字號</div>
                                    <div class="input-data_confirm">
                                        <p>F222388****</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>身分證發證日期</div>
                                    <div class="input-data_confirm">
                                        <p>民國99年12月31日(北市)換發</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>中文姓名</div>
                                    <div class="input-data_confirm">
                                        <p>王大明</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>英文姓名</div>
                                    <div class="input-data_confirm">
                                        <p>Wang Daming</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>性別</div>
                                    <div class="input-data_confirm">
                                        <p>男</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>出生地</div>
                                    <div class="input-data_confirm">
                                        <p>台北市</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>國籍</div>
                                    <div class="input-data_confirm">
                                        <p>中華民國</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm">婚姻狀況</div>
                                    <div class="input-data_confirm">
                                        <p>已婚</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>戶籍地址</div>
                                    <div class="input-data_confirm">
                                        <p>台北市敦化南路二段63巷14號</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>居住地址</div>
                                    <div class="input-data_confirm">
                                        <p>台北市敦化南路二段63巷14號</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>帳單地址</div>
                                    <div class="input-data_confirm">
                                        <p>同戶籍地址</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>寄卡地址</div>
                                    <div class="input-data_confirm">
                                        <p>同戶籍地址</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>行動電話</div>
                                    <div class="input-data_confirm">
                                        <p>0944444222</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm">居住年數</div>
                                    <div class="input-data_confirm">
                                        <p>10年</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>帳單形式</div>
                                    <div class="input-data_confirm">
                                        <p>EMAIL帳單</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>申請數位卡</div>
                                    <div class="input-data_confirm">
                                        <p>是</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>畢業國小名稱</div>
                                    <div class="input-data_confirm">
                                        <p>中山國小</p>
                                    </div>
                                </li>
                ...
                <div class="mb-4 text-left"><strong>職業資料</strong></div>
                <div class="blue_box mb-4">
                    <div class="blue_box_bg">
                        <div class="col-md-12 col-lg-10 m-auto">
                            <ul class="group_confirm ps-0 mb-0">
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>公司名稱</div>
                                    <div class="input-data_confirm">
                                        <p>聯邦網通</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm">統一編號</div>
                                    <div class="input-data_confirm">
                                        <p>16614905</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm">公司地址</div>
                                    <div class="input-data_confirm">
                                        <p>台北市內湖區瑞光路399號5樓</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm">部門名稱</div>
                                    <div class="input-data_confirm">
                                        <p>人事部</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>職業別</div>
                                    <div class="input-data_confirm">
                                        <p>天然能源業/武器製造販售業</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>主要所得及資金來源</div>
                                    <div class="input-data_confirm">
                                        <p>薪資所得</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm"><span class="red_text">* </span>現職月收入</div>
                                    <div class="input-data_confirm">
                                        <p>40,000元</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm">到職日期</div>
                                    <div class="input-data_confirm">
                                        <p>民國99年12月31日</p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="label_confirm">前服務單位名稱</div>
                                    <div class="input-data_confirm">
                                        <p>辦事員</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="label_confirm">前服務單位職稱</div>
                                    <div class="input-data_confirm">
                                        <p>辦事員</p>
                                    </div>
                                </li>
                ...
                <div class="mb-4"><strong>聯邦銀行個人資料使用同意條款</strong></div>
                <div class="blue_box mb-4">
                    <div class="blue_box_bg">
                        <div class="card-body">
                ...
                <div class="blue_box mb-4">
                    <div class="blue_box_bg">
                        <div class="dashed_line mb-3">
                            <div class="mb-3">
                                <input class="Apply_input" name="" id="" runat="server" type="radio" value="Y" checked disabled/>
                                <label class="form-check-label red_text me-3" for="redWord">同意</label><input class="Apply_input" name="" id="" runat="server" type="radio" value="Y" disabled/>
                                <label class="form-check-label red_text" for="redWord">不同意</label><span class="red_text">提供個人資料予貴行有特約合作之第三人</span>
                            </div>
                        </div>
                        <div>
                            <div class="card-body">
                ...
                <div class="mb-4 text-left"><strong>票證功能及帳單形式同意條款：</strong></div>
                <div class="blue_box mb-4">
                    <div class="blue_box_bg">
                        <div class="dashed_line mb-3">
                            <div class="mb-3">
                                <input class="Apply_input" name="" id="" runat="server" type="radio" value="Y" checked disabled />
                                <label class="form-check-label red_text me-3" for="redWord">同意</label><input class="Apply_input" name="" id="" runat="server" type="radio" value="Y" disabled/>
                                <label class="form-check-label red_text" for="redWord">不同意</label>
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="mb-4 text-left"><strong>聯邦銀行LINE官方綁定個人化服務：</strong></div>
                <div class="blue_box mb-4">
                    <div class="blue_box_bg">
                        <div class="col-12 dashed_line mb-3">
                            <div class="mb-3">
                                <input name="exampleRadios" type="radio" class="Apply_input" id="" value="Y"  runat="server" checked disabled />
                                <label class="form-check-label red_text me-3" for="redWord">同意</label><input class="Apply_input" name="exampleRadios" id="" runat="server" type="radio" value="Y" disabled />
                                <label class="form-check-label red_text" for="redWord">不同意</label>
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="mb-4 text-left"><strong>申請悠遊聯名卡者同意卡片已開啟自動加值功能</strong></div>
                <div class="blue_box mb-4">
                    <div class="blue_box_bg">
                        <div class="col-12 mb-3">
                            <div class="my-3">
                                <input class="Apply_input" name="" id="" runat="server" type="checkbox" value="Y" disabled/>
                                <label class="form-check-label me-3" for="redWord">不同意開啟</label>
                            </div>
                        </div>
                    </div>
                </div>
